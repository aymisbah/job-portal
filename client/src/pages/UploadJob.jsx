...
const uploadJob = () => {
  ...
  return (
    <div className='container mx-auto flex flex-col md:flex-row  gap-8 2xl:gap-14 bg-[#fff] px-5 ' >
    <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 mb -4 py-10 md:px-10 shadow-md '>
      <div>
        ...
        >
          ...
          <div className='mt-2'>
            <CustomButton
              type='submit'
              containerStyles='inline-flex justify-center rounded-md border border-transparent bg-[#2A4365] px-8 py-2 text-sm font-medium text-white hover:bg-[#1d4fd846] hover:text-[#1d4fd8] focus:outline-none '
              title='Sumbit'
            />
          </div>
        </form>
