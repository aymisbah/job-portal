...
const JobDetail = () => {
  ...
  return (
    <div className='container mx-auto'>
      <div className='w-full flex flex-col md:flex-col md:flex-row gap-10'>
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
            ...
            <div className='w-full'>
              <CustomButton
                title='Apply Now'
                containerStyles={`w-full flex items-center justify-center text-white bg-[#2A4365] py-3 px-5 outline-none rounded-full text-base`}
              />
          </div>
